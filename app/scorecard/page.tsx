...
function calcOverallScore(weights: Weights) {
            ...
            {[
              ...
              <div key={key}>
                <div className="flex justify-between items-center">
                  <label>{label}</label>
                  <span>{Math.round(weights[key as keyof Weights] * 100)}%</span>
                </div>
                <input
                  type="range"
                  min={0}
                  ...
                  onChange={e => setWeights(w => normalizeWeights(w, key as keyof Weights, parseFloat(e.target.value) || 0))}
